...
```mermaid
graph LR
    A[💡 Idéation] --> B[📊 Analyse marché]
    B --> C[🔍 Benchmarking]
    C --> D[🗳️ Vote & Sélection]
    D --> E[🏆 Projet gagnant]
    E --> F[🚀 Développement MVP]
    F --> G[📈 Lancement]
```
...
[![GitHub stars](https://img.shields.io/github/stars/oussama-filali/start-up-IA?style=social)](https://github.com/oussama-filali/start-up-IA)
[![GitHub forks](https://img.shields.io/github/forks/oussama-filali/start-up-IA?style=social)](https://github.com/oussama-filali/start-up-IA/fork)
